...
const GraphSliverButton = ({
  ...
  const buttonClassName =
    "border border-slate-800 border-b-0 font-bold mr-4 p-1 hover:text-slate-500 hover:bg-slate-300 transition-all duration-300 rounded-md rounded-b-none w-10 pb-1";
  return (
    <button
      className={
        buttonClassName +

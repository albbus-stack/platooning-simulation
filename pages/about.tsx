    ...
    <>
      ...
      <main className="w-full bg-slate-200">
        ...
        <section className="flex flex-col gap-5 px-16 pt-8 pb-16">
          ...
          <p className="text-lg text-slate-800">
            Platooning is a method of driving where a group of vehicles drive in
            a line, with the vehicles in the front of the line controlling the
            speed of the vehicles behind them. This is done to reduce fuel
          ...
          <p className="text-lg text-slate-800">
            ...
            vehicles. The vehicles are controlled by a PID controller, which
            uses the distance between the vehicle and the vehicle in front of it
            to calculate the speed of the vehicle. The PID controller is tuned
            to give the vehicles a comfortable distance between them, and to
            keep the vehicles at a constant speed.
          </p>
